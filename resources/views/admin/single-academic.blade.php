	...
	<form action="{{route('edit-academic')}}" method="POST" enctype="multipart/form-data">
		...
		<div class="container" style="padding:30px;">
			...
			<div class="row">
				...
				<div class="col-md-12 my-2">
					<label for="" class="font-weight-bold">Single Page Content</label>
					<textarea rows="5"  name="single_page_description" required class="form-control ckeditor">{{$academic->single_page_description}}</textarea>
				</div>
				...
				<div class="col-md-12 text-center">
					<hr>
					<a class="btn btn-warning" href="{{ route('admin-academics') }}">All Academics</a>
				</div>
			</div>
		</div>
	</form>
