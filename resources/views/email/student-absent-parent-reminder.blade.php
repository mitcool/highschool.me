                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We are writing to let you know that our records show {{ trim($student->fullname()) }} has not logged in to the ONSITES High School student portal for the past 15 days.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        The last successful login we recorded was on <span style="{{ $style['bold'] }}">{{ optional($lastLoginAt)->format('d.m.Y H:i') }}</span>.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        Please take a moment to check in with your student and make sure everything is on track. Regular access to the student portal is important for following course materials, assessments, schedules, and academic progress.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        If your student is experiencing any difficulties with access or needs support, our team is here to help.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        &rarr; Log In to Student Portal: <a href="{{ route('login') }}">{{ route('login') }}</a>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        Kind regards,<br>ONSITES High School
                                                    </p>
                                                    <p style="{{ $style['paragraph'] }}">
                                                        This email message is being sent to you automatically in connection with the processing of a project because you registered at the HIGHSCHOOL.ME portal as a client, university, or a company as well as accepted the relevant terms and conditions in the course of the registration process. Please do not reply to this email. Log in to your account to carry out the appropriate actions and to use the appropriate communication options available.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
