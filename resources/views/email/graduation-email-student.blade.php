                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                       Congratulations. You did it. Your ONSITES High School diploma and official transcript have been issued and are now available for you to access and download in the student portal.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        This is a real achievement, and it belongs entirely to you. Every hour of study, every exam you prepared for, every challenge you worked through to get here — it has all led to this moment. We hope you take a moment to recognize just how far you have come, and to celebrate it properly.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        Log in to the student portal to access and download your official documents. Please save them in a secure location — you will need them for university applications, scholarship processes, professional opportunities, and any number of important steps in the years ahead.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        If you have ordered a physical diploma package, the delivery details and timeline will be communicated to you separately. A physical diploma is more than a keepsake — in many countries, a physical document is required for apostille certification, which may be necessary for official recognition of your qualification by universities, employers, or government authorities in your country. If apostille services are needed, your parent can request them directly through the parent
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        → Access Your Documents: <a href="{{route('login')}}">{{route('login')}}</a>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                       The entire ONSITES High School team is proud of what you have accomplished. Whatever you choose to pursue next, go forward knowing that you are well prepared and that the effort you put in here has given you a strong foundation. We wish you every success.
                                                    </p>
                                                    <!-- Salutation -->
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        Kind regards,<br>ONSITES High School support team
                                                    </p>
