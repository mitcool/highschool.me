...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('advanced-placement')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('advanced-placement')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
...
<x-image-component nickname="smiling-female-student-tablet-bright-classroom" class="w-100" loading="eager"/>
...
<div class="container-fluid pl-0 pr-0">
    <div class="row text-center w-85 container mx-auto">
        <div class="col-md-12 pb-5">
            <div class="shadow h-100 placement-container">
    ...
    <div class="container-fluid px-0" style="margin-top:20px;padding:20px 0;background-color:#F1F1F1;">
        <div class="page-content container">{!! $texts['last-paragraph'] !!}</p>
