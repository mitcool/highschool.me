...
">
                        ...
                        <li class="nav-item requests">
                            <a class="nav-link collapsed" href="{{route('general-requests')}}">
                               <i class="fas fa-hand-point-right"></i>
                                <span>General Requests</span>
                            </a>
                        </li>
                        <li class="nav-item requests">
                            <a class="nav-link collapsed" href="{{route('program-requests')}}">
                                <i class="fas fa-hand-point-right"></i>
                                <span>Study Program Requests</span>
                            </a>
                        </li>
                        <li class="nav-item requests">
                            <a class="nav-link collapsed" href="{{route('phone-requests')}}">
                               <i class="fas fa-hand-point-right"></i>
                                <span>Phone Requests</span>
                            </a>
                        </li>
                        <li class="nav-item requests">
                            <a class="nav-link collapsed" href="{{route('fact-sheet-requests')}}">
                                <i class="fas fa-hand-point-right"></i>
                                <span>Fact Sheet Requests</span>
                            </a>
                        </li> --}}
                        <div class="sidebar-heading">
                            News
                        ...
                        <li class="nav-item">
                         ...
                         {{-- <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('facts-hub')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Facts Hub</span>
                            </a>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('press-release')}}">
                                <i class="fas fa-fw fa-cog"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('admin-ai-users')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Users</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('admin-ai-services')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Services</span>
                            </a>
                        </li>
                        <hr class="sidebar-divider">
                          <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('admin-ai-texts')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Texts</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('admin-partners')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Partners</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('programs')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Programs</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('studies')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Studies</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('admin-job-categories')}}">
                                <i class="fas fa-fw fa-cog"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('admin-jobs')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Jobs</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('images')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>Public Pages Images</span>
                            </a>
                        </li>
                         <hr class="sidebar-divider">
                        
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('news-images-attributes')}}">
                                <i class="fas fa-fw fa-cog"></i>
                                <span>News Pictures Attributes</span>
                            </a>
                        </li>
                        --}}
                        <hr class="sidebar-divider">
