        ...
        <div class="row">
            <div class="col-md-3 mb-2">
                <div class="shadow h-100 p-3" style="border-radius: 10px;">
                    <i class="fa fa-book-open orange" style="font-size:25px;"></i>
            ...
            <div class="col-md-3 mb-2">
                <div class="shadow h-100 p-3" style="border-radius: 10px;">
                    <i class="fas fa-exchange-alt orange" style="font-size:25px;"></i>
            ...
            <div class="col-md-3 mb-2">
                <div class="shadow h-100 p-3" style="border-radius: 10px;">
                    <i class="fa fa-bullseye orange" style="font-size:25px;"></i>
            ...
            <div class="col-md-3 mb-2">
                <div class="shadow h-100 p-3" style="border-radius: 10px;">
                    <i class="fa fa-globe orange" style="font-size:25px;"></i>
            ...
            <div class="col-md-3">
                <div class="shadow h-100 p-2" style="border-radius: 10px;">
                    <i class="fa fa-robot orange"></i>
            ...
            <div class="col-md-3">
                <div class="shadow h-100 p-2" style="border-radius: 10px;">
                    <i class="fas fa-university orange"></i>
            ...
            <div class="col-md-3">
                <div class="shadow h-100 p-2" style="border-radius: 10px;">
                    <i class="fa fa-arrows-rotate orange"></i>
            ...
            <div class="col-md-3">
                <div class="shadow h-100 p-2" style="border-radius: 10px;">
                    <p class="orange font-weight-bold orange">STUDENT ENGAGEMENT & AWARDS</p>
