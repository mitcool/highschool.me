...
<div class="shadow container jumbotron bg-white">
    ...
    <form action="{{ route('student.add') }}" method="POST" enctype="multipart/form-data">
        ...
        <div  class="mb-3">
            ...
            <input type="text" value="{{ old('middlename') }}" required name="middlename" class="form-control">
        </div>
         <div  class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select name="education_option" id="" required  class="form-control">
                ...
                <option value="1">High School Diploma Programs</option>
                <option value="2">Module , Honors & Prep-Courses</option>
                <option value="3">Learning,Mentoring & Coaching Sessions</option>
            </select>
        </div>
        {{-- <div  class="mb-3">
