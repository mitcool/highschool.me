...
class ParentStudent extends Model
{
    ...
    public function approved_documents_count(){
        return StudentDocument::whereNotIn('type',[2,7,8])->where('student_id',$this->student_id)->where('is_approved',1)->count();
    }

     public function rejected_documents_count(){
        return StudentDocument::whereNotIn('type',[2,7,8])->where('student_id',$this->student_id)->where('is_approved',2)->count();
    }
