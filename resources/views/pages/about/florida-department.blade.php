...
@section('seo')
	...
	<meta itemprop="url" property="og:url" content="{{ route('florida-department')}}"/>
	<meta property="og:description" content="{{ $texts['meta-description'] }}"/>
	<x-meta-image itemprop="image" nickname="accreditation-cover"/>

	<x-seo.web-page-schema :url="route('florida-department')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => 'Recognition & Quality Standards', 'url' => route('accreditation')], ['name' => $texts['heading'], 'url' => route('florida-department')]]" />
