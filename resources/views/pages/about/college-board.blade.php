...
@section('seo')
	...
	<meta itemprop="url" property="og:url" content="{{ route('college-board')}}"/>
	<meta property="og:description" content="{{ $texts['meta-description'] }}"/>
	<x-meta-image itemprop="image" nickname="accreditation-cover"/>

	<x-seo.web-page-schema :url="route('college-board')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => 'Recognition & Quality Standards', 'url' => route('accreditation')], ['name' => $texts['heading'], 'url' => route('college-board')]]" />
...
<div class="container-fluid main_page_container pt-0">
	<div class="row justify-content-center">
		<div class="text-center mb-4">
			<x-image-component nickname="college-board-recognition-diagonal-stripe" loading="eager" />
		</div>
