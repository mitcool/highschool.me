...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('transfer-program')" :name="$texts['breadcrumb']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['breadcrumb'], 'url' => route('transfer-program')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
...
<x-image-component nickname="diverse-international-students-onsites-diplomas" class="w-100" loading="eager"/>
...
<div class="container-fluid pl-0 pr-0">
    <div class="row text-center container mx-auto pt-3 pb-5">
        <div class="col-md-12">
            <div class="shadow h-100 program-container">
