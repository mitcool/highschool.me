...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('country-requirements')" :name="$texts['breadcrumb']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['breadcrumb'], 'url' => route('country-requirements')]]" />
@endsection
