...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('esol')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('esol')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
