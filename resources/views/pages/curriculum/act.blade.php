...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('act')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('act')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
...
<x-image-component nickname="diverse-students-round-table-teacher-smart-board" class="w-100" loading="eager"/>
