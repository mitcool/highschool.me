...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('standard-high-school')" :name="$texts['breadcrumb']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['breadcrumb'], 'url' => route('standard-high-school')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
