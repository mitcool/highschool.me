                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We have a new request for physical copy of enrollement letter with following details:
                                                        <br/>
                                                    </p>
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Name: </span>{{$student->fullname()}}
                                                        <br/>
                                                    </p>
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Copies: </span>{{$copies}}
                                                        <br/>
                                                    </p>
