...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('single-ap-course', $course->id)" :name="$course->course->title" :description="$course->course->title" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $course->course->title, 'url' => route('single-ap-course', $course->id)]]" />
