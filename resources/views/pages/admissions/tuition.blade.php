...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('tuition')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('tuition')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
