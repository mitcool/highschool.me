                                        ...
                                        <table align="center" width="550" cellpadding="10" cellspacing="10">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">You are receiving this email because we received a password reset request for your account.</p>

                                                    <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="{{ route('password.reset',$token) }}" style="{{ $fontFamily }} {{ $style['button'] }}" class="button" target="_blank">
                                                                    Password Reset
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">This password reset link will expire in 60 minutes.</p>
                                                    <!-- Conclusion -->
                                                     <!-- Salutation -->
