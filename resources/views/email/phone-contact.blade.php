                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We are sending you this email to inform you that we have a new request for phone call in GRADUATE.ME
                                                        <br/>
                                                    </p>
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Name: </span>{{$data['name']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">E-Mail: </span>{{$data['email']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Phone: </span>(+{{$data['phone_code']}}) {{$data['phonenumber']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Call time: </span>{{$data['hour']}}
                                                        <br/>
                                                    </p>
