...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('code-of-ethics')" :name="$texts['breadcrumb']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['breadcrumb'], 'url' => route('code-of-ethics')]]" />
@endsection
