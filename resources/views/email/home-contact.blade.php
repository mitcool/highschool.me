                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We are sending you this email to inform you that we have received a new fact sheet request with the following details
                                                        <br/>
                                                    </p>
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Name: </span>{{$data['gender']. ' '.$data['firstname'] .' '. $data['surname']}}
                                                        <br/>
                                                    </p>
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Email: </span>{{$data['email']}}
                                                        <br/>
                                                    </p>
                                                    @if(array_key_exists('phone',$data))
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Phone: </span>+{{$data['phonecode']}} {{$data['phone']}}
                                                        <br/>
                                                    </p>
                                                    @endif
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Program: </span>{{$data['program']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Communication language: </span>{{ $data['communication_language'] }}
                                                        <br/>
                                                    </p>
                                                    <!-- Salutation -->
                                                    <p style="{{ $style['paragraph-black'] }}">
