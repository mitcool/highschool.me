                                        ...
                                        <table align="center" width="550" cellpadding="10" cellspacing="10">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">We are pleased to confirm that the application fee of $150.00 for {{$student->fullname()}}  has been successfully received on {{$now }} via credit card. Thank you for completing this step — {{$student->name}}'s application is now active and being processed by our team.</p>

                                                    <p style="{{ $style['paragraph-black'] }}">No immediate action is required on your part. Our team will now move through the next stages of the application review and will reach out to you with further instructions as each step becomes ready. We aim to keep this process moving as efficiently as possible.</p>

                                                    <p style="{{ $style['paragraph-black'] }}">You can follow the progress of the application at any time through the parent portal. We believe in keeping families fully informed throughout the enrollment journey, and the portal is the best place to track where things stand.</p>

                                                    <p style="{{ $style['paragraph-black'] }}">If any additional documents are needed or further information is requested, you will receive a clear notification with specific instructions. Our Help Desk team is also available if you have any questions in the meantime.</p>

                                                    <p style="{{ $style['paragraph-black'] }}">→ Go to Parent Portal: <a href="{{ route('login') }}">{{ route('login') }}</a></p>

                                                    <p style="{{ $style['paragraph-black'] }}">We appreciate your trust in ONSITES High School and look forward to welcoming {{$student->name}} to our school community.</p>
