...
$style = [
    ...
    'body' => 'margin: 0; padding: 0; width: 100%; background-color: black;',
    'email-wrapper' => 'width: 100%; margin: 0; padding: 0; background-color: black;',
                                            ...
                                            <tr>
                                                <td>
                                                    <h1 style="{{ $style['header-1'] }}">
                                                        Dear {{ $hour->guest->first_name }} {{ $hour->guest->last_name }},
                                                    </h1>
                                                    ...
                                                    <!-- Salutation -->
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        Kind regards,<br>Your GOLD.BIZ support team
                                                    </p>
                                                    <p style="{{ $style['paragraph'] }}">This email message is being sent to you automatically in connection with the processing of a project because you registered at the GOLD.BIZ portal as a client, university, or a company as well as accepted the relevant terms and conditions in the course of the registration process. Please do not reply to this email. Log in to your account to carry out the appropriate actions and to use the appropriate communication options available.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
