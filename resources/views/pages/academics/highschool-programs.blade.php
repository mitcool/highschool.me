...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('highschool-programs')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('highschool-programs')]]" />
