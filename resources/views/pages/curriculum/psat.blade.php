...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('psat')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('psat')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
...
<x-image-component nickname="high-school-students-laptops-colorful-classroom" class="w-100" loading="eager"/>
