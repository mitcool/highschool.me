                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We have wonderful news. {{$student->name}}'s ONSITES High School diploma and official transcript have been issued and are now available in the student portal.                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        This is a milestone worth celebrating — truly. It reflects not only {{$student->name}}'s hard work, determination, and perseverance, but also the consistent support and encouragement you have provided throughout this journey. As a family, you have all played a meaningful role in reaching this point, and we hope you take a moment to acknowledge that together.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        {{$student->name}} can log in to the student portal to access and download the official documents. Please ensure the files are stored safely — they will be needed for university applications, scholarship processes, and a wide range of future opportunities.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        If you have ordered a physical diploma package, the delivery details and timeline will be communicated separately. A physical diploma carries particular importance in many countries, where it is required for apostille certification — an official process that validates the document for use with universities, employers, or government authorities abroad. If apostille services are needed, you can request them directly through the parent portal using the link provided there. If any other questions arise about the documents or the steps ahead, our Help Desk team is available and happy to assist.
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        → Go to Parent Portal: <a href="{{route('login')}}">{{route('login')}}</a>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                       It has been a genuine privilege to be part of {{$student->name}}'s educational journey. We wish the whole family every success and happiness in the chapters ahead.
                                                    </p>
                                                    <!-- Salutation -->
                                                    <p style="{{ $style['paragraph-black'] }}">
