...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('tuition-assistance')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('tuition-assistance')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
