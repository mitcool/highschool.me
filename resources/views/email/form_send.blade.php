                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                     ...
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Name: </span>{{$mail_data['name']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Given Name: </span>{{$mail_data['given_name']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Street & House number: </span>{{$mail_data['street_house_num']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Postal code & city: </span>{{$mail_data['postal_code_city']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Country: </span>{{$mail_data['country']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Phone number: </span>{{$mail_data['phone_num']}}
                                                        <br/>
                                                    </p>
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Email: </span>{{$mail_data['email']}}
                                                        <br/>
                                                    </p>
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Topic of my article #1: </span>{{$mail_data['topic_1']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Topic of my article #2: </span>{{$mail_data['topic_2']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Total fees: </span>{{$mail_data['final_price']}}
                                                        <br/>
                                                    </p>
                                                    <!-- Salutation -->
                                                    <p style="{{ $style['paragraph-black'] }}">
