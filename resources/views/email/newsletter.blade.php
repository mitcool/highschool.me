                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">       
                                <tr>
                                    <td align="center" style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        <!-- Greeting -->
                                        <img src="{{ asset('images/newsletter') }}/{{ $newsletter->cover_image }}" width="570" style="{{ $style['image-hundred'] }}" alt="Image" />
                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                        ...
                                        <p style="{{ $style['paragraph-footer'] }}">
                                            ST. PETERSBURG (Florida) – VARNA (Bulgaria) – WOLLERAU (Switzerland)
                                        </p>
                                        ...
                                        <p style="{{ $style['paragraph-footer'] }}">
                                            <a href="">Programs</a> &nbsp; <a href="https://graduate.me/en/blog">Blog</a> &nbsp; <a href="https://graduate.me/en/faq">FAQ</a>&nbsp; <a href="https://graduate.me/en/student-assistance-team">Student’s Support</a> &nbsp; <a href="https://graduate.me/en/imprint">Imprint</a>                                
                                        </p> 
                                        <p style="{{ $style['paragraph-small'] }}"> 
                                            ONSITES Graduate School LLC | 7901 4th St. N#20418 | St. Petersburg (Florida) 33702, USA
                                            <br> <br>
                                            This e-mail was sent to {{ $newsletter->receiver->email }} <br> 
                                            Please, don’t reply to this e-mail <br>
                                            You have received it because you have subscribed to our newsletter. <br> <br>

                                            If you no longer wish to receive information by email about the latest programs, exclusive offers and special events from the ONSITES Graduate School, you can <a href="{{ config('app.url') }}/en/unsubscribe/{{ $newsletter->receiver->code }}">unsubscribe</a> here at any time
                                        </p>
                                    </td>
                                </tr>
                            </table>
