                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">       
                                <tr>
                                    <td align="center" style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        <!-- Greeting -->
                                        <img src="{{ $message->embed(public_path() . '/images/success_mail.jpg') }}" width="600" style="{{ $style['image-hundred'] }}" alt="Image" />
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We are sending you this email to inform you that we successufully receive your application.
                                                        <br/>
                                                    </p>
                                                    <!-- Salutation -->
                                                    <p style="{{ $style['paragraph-black'] }}">
