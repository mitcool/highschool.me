                                        ...
                                        <table align="center" width="550" cellpadding="10" cellspacing="10">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">There is a new complaint with following details</p>
                                                    <p style="{{ $style['paragraph-black'] }}">Student: {{ $complaint->student->fullname() }}</p>

                                                    <p style="{{ $style['paragraph-black'] }}">Parent: {{ $complaint->student->student_details->parent->fullname() }}</p>

                                                    <p style="{{ $style['paragraph-black'] }}">Educator: {{ $complaint->educator->fullname() }}</p>
                                                    
                                                    <p style="{{ $style['paragraph-black'] }}">Date: {{ $complaint->date->format('d.m.Y') }}</p>

                                                    <p style="{{ $style['paragraph-black'] }}">Complaint: {{ $complaint->text }}</p>
