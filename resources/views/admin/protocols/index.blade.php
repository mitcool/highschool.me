...
<div class="admin-page-content">
    <div class="protocols-page">
        ...
        <div class="protocols-card">
            <form method="GET" action="{{ route('admin.protocols.index') }}" class="protocols-filters">
            ...
            <table class="protocols-table">
                ...
                <tbody>
                    @forelse($students as $student)
                        <tr>
                            <td>{{ trim($student->fullname()) }}</td>
                            <td>{{ optional($student->student_details)->grade ?? '-' }}</td>
                            <td>
                                <a
                                    href="{{ route('admin.protocols.show', ['student_id' => $student->id, 'year' => $selected_year, 'search' => $search]) }}"
