...
<div aria-label="breadcrumb" class="col-md-8 breadcrumb-container mt-4 mb-3">
    <ol class="bg-white breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">PSAT/SAT Prep-Courses</li>
    </ol>
</div>

<img src="{{ asset('images/psat-background.png') }}" alt="" class="w-100">
<div class="container-fluid" style="padding:20px;width:80%;margin:0 auto">
    <h1 class="text-center page-headings">PSAT/SAT Prep-Courses</h1> <br>
