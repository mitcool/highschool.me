...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('learning-mentoring')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('learning-mentoring')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
