...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('terms-and-conditions')" :name="$texts['breadcrumb']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['breadcrumb'], 'url' => route('terms-and-conditions')]]" />
@endsection
