...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('ambassador-program')" :name="$texts['breadcrumb']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['breadcrumb'], 'url' => route('ambassador-program')]]" />
@endsection
@section('headCSS')
<style>
    .h3.blue{
