...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('clep')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('clep')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
...
<div class="container-fluid pl-0 pr-0">
    <div class="row text-center w-85 container mx-auto">
        <div class="col-md-12 pb-5">
            <div class="shadow h-100 clep-container">
