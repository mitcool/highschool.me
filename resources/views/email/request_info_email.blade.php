                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We are sending you this email to inform you that we have a new information request for study program in GRADUATE.ME portal.
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">First Name: </span>{{ $mailObject['name'] }}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Last Name: </span>{{ $mailObject['last_name'] }}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Email: </span>{{ $mailObject['mail'] }}
                                                        <br/>
                                                    </p>
                                                    @if(array_key_exists('phone_number',$mailObject))
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Phone number: </span>+{{ $mailObject['phonecode'] }} {{ $mailObject['phone_number'] }}
                                                        <br/>
                                                    </p>
                                                    @endif
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Name of program: </span>{{ $mailObject['program_name'] }}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">How did the user found us: </span>{{ $mailObject['how_did_you_find'] }}
                                                        <br/>
                                                    </p>
                                                    @if(array_key_exists('more_details',$mailObject))
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">More details: </span>{{ $mailObject['more_details'] }}
                                                        <br/>
                                                    </p>
                                                    @endif
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Communication language: </span>{{ $mailObject['communication_language'] }}
                                                        <br/>
                                                    </p>
                                                    <!-- Salutation -->
                                                    <p style="{{ $style['paragraph-black'] }}">
