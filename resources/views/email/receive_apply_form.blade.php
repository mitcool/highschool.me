                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We are sending you this email to inform you that we have a new application for study program in GRADUATE.ME portal. All details are in your dashboard section "APPLICATIONS"
                                                        <br/>
                                                    </p>
                                                   
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Name of applicant: </span>{{ $mailObject['name'] }} 
                                                        <br/>
                                                        <span style="{{$style['bold']}}">Email: </span>{{ $mailObject['mail'] }} 
                                                        <br/>
                                                        <span style="{{$style['bold']}}">Program name: </span>{{ $mailObjectNameProgram }} 
                                                        <br/>
                                                    </p>
