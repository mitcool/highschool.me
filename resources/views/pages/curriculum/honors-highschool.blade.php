...
@section('seo')
	...
	<x-seo.web-page-schema :url="route('honors-high-school')" :name="$texts['heading']" :description="$texts['meta-description']" :breadcrumbs="[['name' => 'Home', 'url' => route('welcome')], ['name' => $texts['heading'], 'url' => route('honors-high-school')]]" />
@endsection
@section('headCSS')
<style>
    .feature{
...
<x-image-component nickname="diverse-students-tablet-classroom" class="w-100" loading="eager"/>
