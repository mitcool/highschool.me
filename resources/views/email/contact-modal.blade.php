                    ...
                    <tr>
                        <td style="{{ $style['email-masthead'] }}">
                            <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">
                                <img style="height: 50px" src="{{ $message->embed(public_path() . '/images/logo-header-image.png') }}"  alt="Logo" />
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                     ...
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Name: </span>{{$data['name_request']}}
                                                        <br/>
                                                    </p>
                                                     <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Email: </span>{{$data['email_request']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Request Type: </span>{{$data['request_type']}}
                                                        <br/>
                                                    </p>
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        <span style="{{$style['bold']}}">Message: </span>{{$data['message']}}
                                                        <br/>
                                                    </p>
