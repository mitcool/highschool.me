                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        We would like to confirm the following appointment(s):
                                                        <br/>
                                                    </p>
                                                     @foreach ($data as $d )
                                                        <p style="{{ $style['paragraph-black'] }}">
                                                            <span style="{{$style['bold']}}">{{ $d->type() }} on {{ $d->date->format('d.m.Y') }} from {{ $d->start->format('H:i') }} to {{ $d->end->format('H:i') }} (UTC)
                                                            <br/>
                                                        </p>
                                                     @endforeach
