                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="{{ $style['paragraph-black'] }}">
                                                        This is to inform you that our records indicate you did not attend the scheduled examination for the course {{ $exam->course->course->title }} on {{ $exam->datetime->format('d.m.Y H:i') }} (UTC).
