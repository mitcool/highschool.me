...
<x-image-component nickname="examination-rules" class="imprint-images main-pictures-pages" loading="eager"/>

<div class="container-fluid main_page_container">
	
	<div class="row justify-content-center" >
		<div class="col-md-10 col-lg-8 container-style">
			<h1 class="page-headings">{{trans('examination-rules.heading')}}</h1>
			<div class="page-content">{!! trans('examination-rules.text') !!}</div>
