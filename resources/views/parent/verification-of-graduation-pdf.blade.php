...
<body>
    ...
    <hr style="border-top:3px solid blue;">
        ...
        <div style="margin-top:30px;text-align:center;">
            <h1 style="margin-top:20px;font-size:2.2rem;">GRADUATION VERIFICATION LETTER</h1>
            <h4>THIS LETTER IS TO CONFIRM THAT</h4>
            <h1 style="font-size:2rem;color:#E9580C;">{{ $student->fullname() }}</h1>
            <h4>attended ONSITES HIGH SCHOOL and completed all necessary coursework and requirements for their degree,</h4>
